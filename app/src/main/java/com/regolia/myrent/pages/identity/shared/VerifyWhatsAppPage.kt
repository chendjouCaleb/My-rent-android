...
@Composable
fun VerifyWhatsAppPage(email: String) {
    var code by remember { mutableStateOf("") }
    Column {
        Text(text = "Vérification du numéro WhatsApp", style = MaterialTheme.typography.titleMedium)
        Spacer(modifier = Modifier.height(32.dp))

        Text(text = "Vous avons envoyé un code de vérification au numéro WhatsApp: $email")
