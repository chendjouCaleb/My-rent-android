...
@Composable
fun TelegramNumberPage(onValueChange: (value: String) -> Unit) {
    val viewModel = viewModel { PhoneNumberViewModel() }

    Column(Modifier.animateContentSize()) {
        Text(text = "Nous devons vérifier votre numéro Telegram",
        ...
        Row(Modifier.fillMaxWidth()) {
            FluentOutlinedTextField(value = viewModel.indicator,
                onValueChange = {},
            ...
            FluentOutlinedTextField(
                ...
                placeholder = { Text(text = "N° de téléphone Telegram") },
